        ...
        <div class="footer-container">
            ...
            <div class="footer-links">
                ...
                <div class="footer-column">
                    <h4>Kategori</h4>
                    <ul>
                        <li><a href="{{ route('user.allproduk', ['kategori' => 'Roti']) }}"><i class="fas fa-bread-slice"></i> Roti</a></li>
                        <li><a href="{{ route('user.allproduk', ['kategori' => 'kue']) }}"><i class="fas fa-birthday-cake"></i>kue</a></li>
                        <li><a href="{{ route('user.allproduk', ['kategori' => 'Pastry']) }}"><i class="fas fa-cookie"></i> Pastry</a></li>
                        <li><a href="{{ route('user.allproduk', ['kategori' => 'donat']) }}"><i class="fas fa-cookie-bite"></i>Donat</a></li>
                        <li><a href="{{ route('user.allproduk', ['kategori' => 'spesial']) }}"><i class="fas fa-cookie-bite"></i>Spesial</a></li>
                    </ul>
                </div>
